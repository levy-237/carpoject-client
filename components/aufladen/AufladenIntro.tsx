    ...
    <section className="px-4 py-12 max-md:py-8">
      <div className="mx-auto max-w-4xl rounded-3xl border border-gray-200 bg-white p-8 shadow-lg sm:p-10">
        ...
        <p className="mt-4 max-w-2xl text-base leading-7 text-gray-600">
          Beim Kauf zählt nicht nur die Reichweite auf dem Papier. Ob du zuhause,
          am Arbeitsplatz oder nur unterwegs laden kannst, macht im Alltag den
          Unterschied. Hier findest du die wichtigsten Infos — ohne
          Fachchinesisch.
        </p>
        <Link
          href="/listings"
